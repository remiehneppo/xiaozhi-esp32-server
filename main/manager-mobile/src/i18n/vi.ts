...
export default {
    ...
    'home.createAgent': 'Tạo trợ lý',
    'home.agentName': 'Trợ lý',
    ...
    'home.emptyState': 'Chưa có trợ lý nào',
    'home.deviceManagement': 'Quản lý thiết bị',
    'home.lastConversation': 'Cuộc trò chuyện cuối:',
    'home.delete': 'Xóa',
    'home.createFirstAgent': 'Nhấn vào nút + ở góc dưới bên phải để tạo trợ lý đầu tiên của bạn',
    'home.dialogTitle': 'Tạo trợ lý',
    ...
    'agent.agentName': 'Tên trợ lý',
    'agent.inputAgentName': 'Vui lòng nhập tên trợ lý',
    'agent.roleMode': 'Chế độ vai trò',
    'agent.agentTag': 'Nhãn trợ lý',
    'agent.addAgentTag': 'Thêm nhãn',
    'agent.inputAgentTag': 'Vui lòng nhập nhãn trợ lý',
    'agent.contextProvider': 'Nguồn dữ liệu ngữ cảnh',
    'agent.contextProviderSuccess': 'Đã thêm thành công {count} nguồn dữ liệu ngữ cảnh.',
    'agent.contextProviderDocLink': 'Cách triển khai nguồn dữ liệu ngữ cảnh',
    'agent.editContextProvider': 'Chỉnh sửa nguồn dữ liệu ngữ cảnh',
    ...
    'agent.voiceprint': 'Mẫu giọng nói',
    ...
    'agent.pleaseInputAgentName': 'Vui lòng nhập tên trợ lý',
    ...
    'agent.ttsPitch': 'Cao độ',
    'agent.volumeHint': '-100=Thấp nhất, 0=Tiêu chuẩn, 100=Cao nhất',
    'agent.speedHint': '-100=Chậm nhất, 0=Tiêu chuẩn, 100=Nhanh nhất',
    'agent.pitchHint': '-100=Thấp nhất, 0=Tiêu chuẩn, 100=Cao nhất',
  ...
  'manualAddDeviceDialog.bindWithCode': 'Liên kết bằng mã xác minh 6 chữ số',
    ...
    'chatHistory.noSelectedAgent': 'Chưa chọn trợ lý',
    ...
    'chatHistory.chatRecordsDescription': 'Bản ghi trò chuyện với trợ lý sẽ hiển thị ở đây',
    ...
    'device.pleaseSelectAgent': 'Vui lòng chọn một trợ lý trước',
    ...
    'device.clickToBindFirstDevice': 'Nhấn vào nút + ở góc dưới bên phải để liên kết thiết bị đầu tiên của bạn',
    ...
    // Trang dấu giọng nói
    'voiceprint.noSelectedAgent': 'Chưa chọn trợ lý',
    'voiceprint.pleaseSelectAgent': 'Vui lòng chọn một trợ lý trước',
    'voiceprint.fetchHistoryFailed': 'Không thể tải lịch sử trò chuyện',
    'voiceprint.clickToSelectVector': 'Nhấn để chọn mẫu giọng nói',
    'voiceprint.pleaseInputName': 'Vui lòng nhập tên',
    'voiceprint.pleaseSelectVector': 'Vui lòng chọn mẫu giọng nói',
    ...
    'voiceprint.emptyTitle': 'Chưa có dữ liệu giọng nói',
    'voiceprint.emptyDesc': 'Nhấn vào nút + ở góc dưới bên phải để thêm người nói đầu tiên của bạn',
    'voiceprint.addSpeaker': 'Thêm người nói',
    'voiceprint.voiceVector': 'Mẫu giọng nói',
    'voiceprint.name': 'Tên',
    ...
    'voiceprint.selectVector': 'Chọn mẫu giọng nói',
    'voiceprint.voiceprintInterfaceNotConfigured': 'Chưa cấu hình giao diện nhận dạng giọng nói',
    ...
    'settings.aboutContent': 'Bảng điều khiển XiaoZhi\n\nỨng dụng quản lý di động đa nền tảng được xây dựng với Vue.js 3 + uni-app, cung cấp quản lý thiết bị, cấu hình trợ lý và các chức năng khác cho phần cứng thông minh XiaoZhi ESP32.\n\n© 2025 xiaozhi-esp32-server {version}',
    ...
    'message.invalidAddress': 'Địa chỉ có thể không hợp lệ. Vui lòng kiểm tra xem máy chủ đã khởi động và mạng có ổn định không. Có thể yêu cầu không gửi được do lỗi giao thức HTTPS',
    ...
    'agent.tools.pageTitle': 'Công cụ của trợ lý',
    'agent.tools.unselected': 'Chưa chọn',
    'agent.tools.selected': 'Đã chọn',
    'agent.tools.noMorePlugins': 'Không còn plugin nào',
    'agent.tools.pleaseSelectPlugin': 'Vui lòng chọn plugin',
    ...
    'agent.tools.clickToConfigure': 'Nhấn để cấu hình',
    ...
    'deviceConfig.clickToRefreshScan': 'Vui lòng nhấn Làm mới quét',
    ...
    'deviceConfig.clickGenerateAndPlaySoundWave': 'Nhấn Tạo và phát sóng âm, hệ thống sẽ mã hóa thông tin cấu hình thành âm thanh',
    ...
    'deviceConfig.clickRefreshScan': 'Vui lòng nhấn Làm mới quét',
    ...
    'deviceConfig.clickStartConfigAndWait': 'Nhấn Bắt đầu cấu hình và chờ',
