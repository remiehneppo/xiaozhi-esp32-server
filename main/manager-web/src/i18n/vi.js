export default {
  ...
  'header.smartManagement': 'Quản lý trợ lý AI',
  'header.modelConfig': 'Mô hình',
  'header.knowledgeBase': 'Kho tri thức',
  'header.voiceCloneManagement': 'Quản lý nhân bản giọng nói',
  ...
  'header.agentTemplate': 'Mẫu trợ lý mặc định',
  ...
  'header.searchPlaceholder': 'Tên, thẻ hoặc MAC',
  ...
  'mcpToolCall.prop.chipModel': 'Loại chip',
  ...
  'editVoiceDialog.defaultLanguageType': 'Tiếng Trung giản thể',
  ...
  'firmwareDialog.clickUpload': 'Nhấn để tải lên',
  ...
  'voicePrintDialog.voicePrintVector': 'Mẫu giọng nói',
  'voicePrintDialog.selectVoiceMessage': 'Vui lòng chọn một mẫu âm thanh',
  ...
  'voicePrintDialog.requiredAudioVector': 'Vui lòng chọn mẫu giọng nói',

  // Context provider dialog related
  'contextProviderDialog.title': 'Chỉnh sửa nguồn dữ liệu ngữ cảnh',
  'contextProviderDialog.noContextApi': 'Không có API nguồn ngữ cảnh',
  ...
  'contextProviderDialog.requestHeaders': 'Tiêu đề yêu cầu',
  'contextProviderDialog.headerKeyPlaceholder': 'Tên tiêu đề',
  'contextProviderDialog.headerValuePlaceholder': 'Giá trị',
  'contextProviderDialog.noHeaders': 'Chưa có tiêu đề',
  'contextProviderDialog.addHeader': 'Thêm tiêu đề',
  'contextProviderDialog.cancel': 'Hủy bỏ',
  'contextProviderDialog.confirm': 'Xác nhận',

  // Role config page - context provider related
  'roleConfig.contextProvider': 'Nguồn dữ liệu ngữ cảnh',
  'roleConfig.contextProviderSuccess': 'Đã thêm thành công {count} nguồn dữ liệu ngữ cảnh.',
  'roleConfig.contextProviderDocLink': 'Cách triển khai nguồn dữ liệu ngữ cảnh',
  'roleConfig.editContextProvider': 'Chỉnh sửa nguồn dữ liệu ngữ cảnh',
  ...
  'replacementDialog.clickUploadTip': 'Nhấn để tải lên tệp thay thế',
  ...
  'device.searchPlaceholder': 'Vui lòng nhập mẫu thiết bị hoặc địa chỉ MAC để tìm kiếm',
  ...
  // Voiceprint related
  'voiceprint.management': 'Quản lý giọng nói',
  'voiceprint.add': 'Thêm giọng nói',
  'voiceprint.delete': 'Xóa giọng nói',
  ...
  'home.confirmDeleteAgent': 'Bạn có chắc chắn muốn xóa trợ lý này?',
  ...
  'addAgentDialog.title': 'Thêm trợ lý',
  'addAgentDialog.agentName': 'Tên trợ lý',
  'addAgentDialog.placeholder': 'Vui lòng nhập tên trợ lý..',
  'addAgentDialog.confirm': 'Xác nhận',
  'addAgentDialog.cancel': 'Hủy bỏ',
  'addAgentDialog.nameRequired': 'Vui lòng nhập tên trợ lý',
  ...
  'roleConfig.agentName': 'Tên trợ lý',
  ...
  'roleConfig.tooltip.agentName': 'Đặt tên cho trợ lý AI của bạn để nhận dạng và nhận biết',
  'roleConfig.tooltip.roleTemplate': 'Chọn một mẫu vai trò có sẵn để nhanh chóng thiết lập các cài đặt cơ bản cho trợ lý của bạn',
  'roleConfig.tooltip.contextProvider': 'Khi XiaoZhi được kích hoạt, lấy dữ liệu từ nguồn bên ngoài và chèn động vào prompt hệ thống của LLM',
  'roleConfig.tooltip.roleIntroduction': 'Xác định vai trò, tính cách, quy tắc ứng xử và nền tảng kiến thức chuyên môn của trợ lý AI',
  ...
  'roleConfig.tooltip.interactionLanguage': 'Đặt ngôn ngữ giao tiếp chính mà trợ lý AI sẽ sử dụng',
  ...
  'roleConfig.tooltip.llm': 'Mô hình ngôn ngữ chính (Large Language Model): phần trung tâm giúp trợ lý AI hiểu ý định người dùng, tạo phản hồi và xử lý nhiệm vụ',
  'roleConfig.tooltip.slm': 'Mô hình ngôn ngữ nhỏ (Small Language Model): dùng để kích hoạt trợ lý AI và tạo tiêu đề tóm tắt ký ức',
  'roleConfig.tooltip.vllm': 'Mô hình ngôn ngữ lớn đa phương thức: xử lý hình ảnh và video, cho phép trợ lý AI phân tích và mô tả nội dung từ camera',
  ...
  'roleConfig.tooltip.voiceType': 'Chọn giọng nói cho trợ lý AI; mỗi giọng có phong cách riêng. Một số giọng hỗ trợ nghe thử, nhấn nút phát để xem trước',
  ...
  'functionDialog.pleaseSelectPlugin': 'Vui lòng chọn plugin',
  ...
  'functionDialog.mcpAddressDesc': 'Dưới đây là các địa chỉ điểm truy cập MCP cho trợ lý.',
  ...
  'templateQuickConfig.agentSettings.agentName': 'Tên trợ lý',
  'templateQuickConfig.agentSettings.agentNamePlaceholder': 'Vui lòng nhập tên trợ lý',
  ...
  'voiceClone.platformName': 'Nền tảng',
  'voiceClone.voiceId': 'ID giọng nói',
  'voiceClone.userId': 'Tài khoản sở hữu',
  ...
  'voiceClone.addVoiceClone': 'Thêm giọng nói',
  'voiceClone.confirmDelete': 'Bạn có chắc chắn muốn xóa {count} giọng nói đã chọn?',
  'voiceClone.deleteSuccess': 'Đã xóa thành công {count} giọng nói',
  ...
  'voiceClone.selectFirst': 'Vui lòng chọn giọng nói để xóa trước',
  'voiceClone.operationCancelled': 'Hủy bỏ',
  'voiceClone.operationClosed': 'Đã đóng hộp thoại',
  ...
  'voiceClone.onlySuccessCanClone': 'Chỉ có thể nhân bản giọng nói đã huấn luyện thành công',
  'common.insufficient': 'Không đủ',
  'voiceClone.platformNameRequired': 'Vui lòng chọn nền tảng',
  'voiceClone.voiceIdRequired': 'Vui lòng chọn ID giọng nói',
  'voiceClone.userIdRequired': 'Vui lòng chọn tài khoản sở hữu',
  'voiceClone.platformNamePlaceholder': 'Vui lòng chọn nền tảng',
  'voiceClone.voiceIdPlaceholder': 'Vui lòng nhập ID giọng nói rồi nhấn Enter',
  'voiceClone.userIdPlaceholder': 'Vui lòng nhập từ khóa để chọn tài khoản sở hữu',
  'voiceClone.languages': 'Ngôn ngữ',
  'voiceClone.languagesPlaceholder': 'Vui lòng nhập ngôn ngữ, ví dụ: Tiếng Việt, Tiếng Anh',
  ...
  'voiceClone.noVoiceCloneAssigned': 'Tài khoản của bạn chưa được cấp tài nguyên giọng nói',
  'voiceClone.contactAdmin': 'Vui lòng liên hệ quản trị viên để được cấp tài nguyên giọng nói',
  'voiceClone.dialogTitle': 'Nhân bản giọng nói',
  'voiceClone.stepUpload': 'Chuẩn bị mẫu âm thanh',
  'voiceClone.stepEdit': 'Chỉnh sửa mẫu âm thanh',
  'voiceClone.dragOrClick': 'Kéo tệp âm thanh vào đây hoặc nhấn để tải lên',
  'voiceClone.uploadTip': 'Hỗ trợ các định dạng âm thanh phổ biến. Đoạn chọn phải dài từ 8 đến 60 giây',
  'voiceClone.editTip1': 'Vui lòng kiểm tra xem âm thanh đã tải lên có đạt yêu cầu không',
  'voiceClone.editTip2': 'Bạn có thể nghe thử và cắt đoạn âm thanh. Nếu chưa ưng ý, hãy quay lại để ghi âm hoặc tải lên lại',
  ...
  'voiceClone.loadAudioFailed': 'Không thể tải tệp âm thanh',
  ...
  'knowledgeBaseManagement.title': 'Kho tri thức',
  'knowledgeBaseManagement.searchPlaceholder': 'Vui lòng nhập tên kho tri thức để tìm kiếm',
  'knowledgeBaseManagement.search': 'Tìm kiếm',
  'knowledgeBaseManagement.name': 'Tên kho tri thức',
  'knowledgeBaseManagement.description': 'Mô tả kho tri thức',
  ...
  'knowledgeBaseManagement.addKnowledgeBase': 'Thêm kho tri thức',
  'knowledgeBaseManagement.editKnowledgeBase': 'Chỉnh sửa kho tri thức',
  'knowledgeBaseManagement.getKnowledgeBaseListFailed': 'Không thể lấy danh sách kho tri thức',
  'knowledgeBaseManagement.selectKnowledgeBaseFirst': 'Vui lòng chọn kho tri thức để xóa trước',
  'knowledgeBaseManagement.confirmBatchDelete': 'Bạn có chắc chắn muốn xóa {count} kho tri thức đã chọn?',
  'knowledgeBaseManagement.batchDeleteSuccess': 'Đã xóa thành công {count} kho tri thức',
  ...
  'knowledgeBaseDialog.title': 'Kho tri thức',
  'knowledgeBaseDialog.name': 'Tên kho tri thức',
  'knowledgeBaseDialog.namePlaceholder': 'Vui lòng nhập đúng tên kho tri thức để tăng độ chính xác khi truy xuất',
  'knowledgeBaseDialog.description': 'Mô tả kho tri thức',
  'knowledgeBaseDialog.descriptionPlaceholder': 'Vui lòng nhập mô tả rõ ràng để mô hình hiểu đúng nội dung trong kho tri thức',
  ...
  'knowledgeBaseDialog.requiredName': 'Vui lòng nhập tên kho tri thức',
  'knowledgeBaseDialog.nameRequired': 'Vui lòng nhập tên kho tri thức',
  'knowledgeBaseDialog.nameLength': 'Tên kho tri thức nên dài từ 1 đến 50 ký tự',
  'knowledgeBaseDialog.namePattern': 'Tên kho tri thức chỉ có thể chứa chữ tiếng Việt, chữ cái tiếng Anh, số, khoảng trắng, gạch dưới và gạch ngang',
  'knowledgeBaseDialog.descriptionLength': 'Mô tả kho tri thức không được vượt quá 200 ký tự',
  'knowledgeBaseDialog.nameLengthLimit': 'Tên kho tri thức không được vượt quá 50 ký tự',
  'knowledgeBaseDialog.descriptionLengthLimit': 'Mô tả kho tri thức không được vượt quá 200 ký tự',
  ...
  'knowledgeFileUpload.clickToUpload': 'Nhấn để tải lên',
  ...
  'knowledgeFileUpload.dragOrClick': 'Kéo tệp vào đây hoặc nhấn để tải lên',
  'knowledgeFileUpload.cancel': 'Hủy bỏ',
  'knowledgeFileUpload.confirm': 'Xác nhận',
  'knowledgeFileUpload.knowledgeBaseName': 'Tên kho tri thức',
  ...
  'featureManagement.group.featureManagement': 'Có bật tính năng này hay không',
  'featureManagement.group.voiceManagement': 'Có hiển thị trong cấu hình trợ lý hay không',
  ...
  'feature.voiceClone.name': 'Nhân bản giọng nói',
  'feature.voiceClone.description': 'Sử dụng công nghệ AI để tạo bản sao giọng nói, phục vụ tổng hợp giọng nói cá nhân hóa',
  'feature.knowledgeBase.name': 'Kho tri thức',
  'feature.knowledgeBase.description': 'Xây dựng và quản lý kho tri thức, giúp trợ lý AI tra cứu kiến thức chuyên môn',
  ...
  'addressBookManagement.selectAgent': 'Vui lòng chọn trợ lý',
  ...
  'addressBookManagement.selectAgentFirst': 'Vui lòng chọn trợ lý trước',
  ...
  'addressBookManagement.agentNameUpdated': 'Tên trợ lý đã được cập nhật',
  'addressBookManagement.updateFailed': 'Cập nhật thất bại',
