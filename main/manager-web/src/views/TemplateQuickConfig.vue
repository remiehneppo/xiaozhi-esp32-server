      ...
      <div class="content-panel">
        <div class="content-area">
          <el-card class="config-card" shadow="never">
              ...
              <!-- Sử dụng các hiệu ứng biểu tượng đầy màu sắc giống như trang cấu hình nhân vật -->
...
export default {
  ...
  data() {
    return {
      form: {
        agentCode: this.$t('templateQuickConfig.defaultAgentCode'),
        agentName: "",
        systemPrompt: "",
        sort: 0,
  ...
  methods: {
    ...
    prepareConfigData() {
      return {
        ...
        sort: this.form.sort,
        functions: [],
        // Bao gồm các trường mô hình cần thiết để đảm bảo lệnh gọi API thành công
        ...this.form.model
      };
    },
    ...
    // Lấy danh sách mẫu và đặt số sắp xếp
  ...
  // Việc khởi tạo được thực hiện khi thành phần được gắn kết
  mounted() {
    ...
    if (templateId) {
      ...
      // Chế độ mới: đặt giá trị mặc định và nhận số thứ tự
