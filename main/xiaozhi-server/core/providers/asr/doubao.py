...
def parse_response(res):
    ...
    reserved （8bits) giữ lại
    header_extensions (v.v.tại 8 * 4 * (header_size - 1) )
    payload vớihttp yêu cầu
    """
...
class ASRProvider(ASRProviderBase):
        ...
        try:
            ...
            async with websockets.connect(
                ...
                if (
                    ...
                    and result["payload_msg"]["code"] != 1013  # hiệu quảgiọng nóilỗi
                ):
    ...
    async def speech_to_text(
        ...
        try:
            ...
            # làm chosử dụngPCMdữ liệu
            # tính toán (, 16bit, 16kHztần số lấy mẫu)
