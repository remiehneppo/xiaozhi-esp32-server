...
@Tag(name = "Nhà cung cấp mô hình")
public class ModelProviderController {

    private final ModelProviderService modelProviderService;

    @GetMapping
    @Operation(summary = "Lấy danh sách nhà cung cấp mô hình")
    ...
    @PostMapping
    @Operation(summary = "Thêm nhà cung cấp mô hình mới")
    @RequiresPermissions("sys:role:superAdmin")
    ...
    @PutMapping
    @Operation(summary = "Chỉnh sửa nhà cung cấp mô hình")
    @RequiresPermissions("sys:role:superAdmin")
    ...
    @PostMapping("/delete")
    @Operation(summary = "Xóa nhà cung cấp mô hình")
    @RequiresPermissions("sys:role:superAdmin")
    @Parameter(name = "ids", description = "Mảng ID", required = true)
    ...
    @Tag(name = "Lấy danh sách tên plugin")
