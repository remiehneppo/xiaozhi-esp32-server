...
CREATE TABLE `ai_model_provider` (
    ...
    `name` VARCHAR(100) COMMENT 'tên nhà cung cấp',
...
CREATE TABLE `ai_model_config` (
    ...
    `model_name` VARCHAR(100) COMMENT 'Tên mẫu',
...
CREATE TABLE `ai_tts_voice` (
    ...
    `name` VARCHAR(100) COMMENT 'Tên giọng nói',
    `tts_voice` VARCHAR(50) COMMENT 'mã hóa âm sắc',
    `languages` VARCHAR(100) COMMENT 'Ngôn ngữ',
...
CREATE TABLE `ai_agent_template` (
    ...
    `language` VARCHAR(50) COMMENT 'ngôn ngữ tương tác',
