-- Làm sạch hàng loạt định nghĩa trường sample_rate trong ai_model_provider
...
-- Dọn dẹp thông số sample_rate của Minimax streaming TTS (nằm bên trong audio_setting)
